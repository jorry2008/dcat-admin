...
class Field implements Renderable
{
    ...
    public function value($value = null)
    {
        if (is_null($value)) {
            ...
            if(is_array($this->value) && is_array($this->default()) && count($this->value)==count($this->value, 1) && count(array_unique($this->value)) == 1 && array_values(array_unique($this->value))[0] === null) {
